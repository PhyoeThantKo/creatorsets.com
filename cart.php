     ...
     <section class="w-full px-8">
          <div class="bg-white my-20 pb-5 max-w-5xl mx-auto rounded-2xl">
               ...
               <div class="p-12">
                         ...
                         <form action="./cartDone.php" name="customer_info" method="POST">
                              <!--Cart-->
                              <div id="cart">
                                   ...
                                   <div class="flex justify-between items-center">
                                        <div class="w-2/3 leading-relaxed">
                                             <div class="flex justify-between">
                                                  <div>
                                                       <label><input type="radio" id="paymonthly" name="payment_sequence" value="Pay Monthly" required>   Pay Monthly</label><br>
                                                  </div>
                                                  <div>
                                                       <span id="mo_price">
                                             ...
                                             <div class="flex justify-between py-3">
                                                  <div>
                                                       <label><input type="radio" id="annually" name="payment_sequence" value="Pay Annually" required>   Pay Annually</label><br>
                                                  </div>
                                                  <div>
                                                       <span id="an_price">
